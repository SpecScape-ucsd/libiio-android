...
LOCAL_C_INCLUDES += /home/jason/Desktop/Work5-SDR/libiio-external-android/
...
LOCAL_C_INCLUDES += /home/jason/Desktop/Work5-SDR/aarch-lib/dynamicinclude/
LOCAL_C_INCLUDES += /home/jason/Desktop/Work5-SDR/libiio-external-android/
LOCAL_SRC_FILES := ../tests/iio_readdev.c ../tests/iio_common.c
LOCAL_SHARED_LIBRARIES := iio usb
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := iio_adi_xflow_check
LOCAL_CFLAGS += -Wall -Wextra
LOCAL_CXXFLAGS += -Weffc++
LOCAL_C_INCLUDES += /home/jason/Desktop/Work5-SDR/aarch-lib/dynamicinclude/
LOCAL_C_INCLUDES += /home/jason/Desktop/Work5-SDR/libiio-external-android/
LOCAL_SRC_FILES := ../examples/iio_adi_xflow_check.c ../tests/iio_common.c
LOCAL_SHARED_LIBRARIES := iio usb
