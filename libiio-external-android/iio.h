...
__api __check_ret ssize_t iio_scan_context_get_info_list_android(struct iio_scan_context *ctx,
...
__api __check_ret struct iio_context * iio_create_context_from_uri_android(const char *uri, int *fd);
